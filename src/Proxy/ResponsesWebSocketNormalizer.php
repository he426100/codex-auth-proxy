...
final class ResponsesWebSocketNormalizer
{
    ...
    public function normalizeForHttpFallbackWithReport(string $payload): NormalizedPayload
    {
        return $this->normalizer->normalizeWebSocketHttpFallbackWithReport($payload);
    }
}
